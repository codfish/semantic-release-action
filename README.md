...
| release-channel       | The npm distribution channel of the new release.                                                                                                  |
...
| RELEASE_CHANNEL       | The npm distribution channel of the new release.                                                                                                  |
| RELEASE_NOTES         | The release notes of the next release.                                                                                                 |
